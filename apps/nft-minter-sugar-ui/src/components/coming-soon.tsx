      ...
      <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 lg:px-8 min-h-[70vh] flex flex-col justify-center">
        ...
        >
          <div className="bg-white/5 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-outfit">Our team is working hard to bring you an amazing experience.</p>
          </div>
          ...
          <div className="bg-white/5 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-outfit">Sign up below to be the first to know when we launch.</p>
          </div>
        </motion.div>

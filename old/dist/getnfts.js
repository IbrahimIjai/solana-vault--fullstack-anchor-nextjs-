...
function convertToSugarFormat(originalMetadata, imageFileName) {
    return {
...
async function downloadNFT(tokenId) {
    try {
...
// Create placeholder files if download fails
function createPlaceholderFiles(index) {
    try {
...
async function createCollectionFiles() {
...
async function createMetaJson(walletAddress = "6t3yY8oi2uCupcKdbHeg1XeHCmjnnWVPfzMdSNhVMZfy") {
...
async function createMetaplexNftJson(index, walletAddress) {
    try {
...
async function createMetaplexCollectionJson(walletAddress) {
    try {
